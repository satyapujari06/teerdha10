...
####   Django- Why Choose us ####
   ...
   ######....BUSES....#####
    ...
    path('bus_whychoose_faq_op/',bus_views.bus_whychoose_faq_op),



    path('bus_whychoose_delete/<int:id>',bus_views.bus_whychoose_delete,name="whychoose_delete"),
    path('bus_whychoose_update/<int:id>',bus_views.bus_whychoose_update,name="whychoose_update"),
    path('bus_whychoose_edit/<int:id>',bus_views.bus_whychoose_edit,name="whychoose_edit"),


    path('bus_faq_delete/<int:id>',bus_views.bus_faq_delete,name="faq_delete"),
    path('bus_faq_update/<int:id>',bus_views.bus_faq_update,name="faq_update"),
    path('bus_faq_edit/<int:id>',bus_views.bus_faq_edit,name="faq_edit"),



    path('bus_whychoose_upd/',bus_views.bus_whychoose_upd),
